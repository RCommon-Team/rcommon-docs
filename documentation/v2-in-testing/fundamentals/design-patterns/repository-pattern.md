...
Through the repository pattern, we are able to a variety of other patterns that are commonly used in enterprise applications. Such patterns include [specifications](../../../../v1/fundamentals/design-patterns/specification-pattern.md), eager loading, pagination, and [unit of work (UoW)](../../../../v1/fundamentals/design-patterns/unit-of-work.md).&#x20;
